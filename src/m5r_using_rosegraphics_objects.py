...
#                radius, center, fill_color
#
#     f. What does a RoseWindow RENDER method do?
#            Makes the window show up/appear, or render, and redraws all the shapes attached to it. Like an update or
#  refresh.
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            When you want a user to prompt the closing of the window; if you want the user to prompt the next
# computation, use continue_on_mouse_click.
#
